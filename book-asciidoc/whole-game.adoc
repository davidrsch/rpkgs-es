...
....
#> ✔ Creating '/tmp/RtmpZRxZV7/regexcite/'
#> ✔ Setting active project to '/tmp/RtmpZRxZV7/regexcite'
#> ✔ Creating 'R/'
#> ✔ Writing 'DESCRIPTION'
#> Package: regexcite
...
|b2808288db… |Quarto GHA Workflow Runner quarto-github-actions-publish@example.com |Initial commit
|===
...
....
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/RtmpZRxZV7/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.4.0/lib/R/bin/R CMD INSTALL \
  /tmp/RtmpZRxZV7/regexcite_0.0.0.9000.tar.gz --install-tests 
...
#> ℹ Building '/tmp/RtmpZRxZV7/regexcite/README.Rmd'
----
