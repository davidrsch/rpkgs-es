...
....
#> ✔ Creating '/tmp/RtmpdxWQqq/regexcite/'
#> ✔ Setting active project to '/tmp/RtmpdxWQqq/regexcite'
#> ✔ Creating 'R/'
#> ✔ Writing 'DESCRIPTION'
#> Package: regexcite
...
|f40650b5c4… |Quarto GHA Workflow Runner quarto-github-actions-publish@example.com |Initial commit
|===
...
....
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/RtmpdxWQqq/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.4.0/lib/R/bin/R CMD INSTALL \
  /tmp/RtmpdxWQqq/regexcite_0.0.0.9000.tar.gz --install-tests 
...
#> ℹ Building '/tmp/RtmpdxWQqq/regexcite/README.Rmd'
----
